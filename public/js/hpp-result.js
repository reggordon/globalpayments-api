...
// If no parameters or result is missing, show an error
if (!result && !orderId) {
    container.innerHTML = `
        <div class="success-page">
            <div class="success-icon error">⚠</div>
            <h1 class="success-title error">Invalid Payment Result</h1>
            <p class="success-message">This page should not be accessed directly. Please initiate a payment from the HPP payment page.</p>
            <div class="nav-buttons">
                <a href="/hpp-options.html" class="btn-primary">Return to Payment Options</a>
